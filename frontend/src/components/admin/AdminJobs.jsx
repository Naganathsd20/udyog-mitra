    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5 mb-8">
          <div>
            <h1 className="flex items-center gap-3 text-3xl sm:text-4xl font-bold text-slate-900">
              <BriefcaseBusiness className="text-violet-600 h-8 w-8 sm:h-[34px] sm:w-[34px]" />
              Jobs
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 sm:p-6 hover:shadow-lg transition-all duration-300">
